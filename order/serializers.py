...
class CreateOrderSerializer(serializers.Serializer):
    ...
    # this will check weather a cart exsist, if yes then is it have any item added or not
    ...
    # this will create a order from the cart and then cart will be deleted
    def create(self, validated_data):
        user_id = self.context['user_id']
        cart_id = validated_data['cart_id']


        # ai pura jinish ta ke services.py file a implement kora hoise 
    ...
    # uporer order ta direct return hoy na tai aita use kora lage
...
class UpdateOrderSerializer(serializers.ModelSerializer):
    ...
    # dont need this beacuse in ViewSet 'cancel action' will do this
