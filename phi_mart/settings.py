...
SECRET_KEY = 'django-insecure-dy5rc-gxd0x+ajmg4jzco2v$mt32d09sgp7l0-jlgev_8d_clj'
...
# STATIC_FILES_DIR = BASE_DIR / "static" # for local static file
...
REST_FRAMEWORK = {
    ...
    # All API views now require login by default.
